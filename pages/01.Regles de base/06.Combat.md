...
Si l'arme utilisée a un facteur de Pénétration, modifiez en conséquence la Difficulté du jet de Dommages. Le profil des Rencontres indique l'endurance sous la forme suivante :

> Endurance : 4(3)

Cela signifie que l'Endurance est de 4 en général, mais que l'Endurance naturelle (hors protection, donc) est de 3. Une arme avec une Pénétration de 1 utilisera donc cette Endurance de 3. Une arme avec une Pénétration de 2 également.

> Endurance 6(4)

Dans ce cas, l'arme avec une Pénétration de 1 sera opposée à une Difficulté de 5 pour le jet de Difficulté.
